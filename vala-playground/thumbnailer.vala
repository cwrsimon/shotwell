...
class ShotwellThumbnailer {
    ...
    public static int main(string[] args) {
        ...
        try {
            ...
            // Consider sending base64 content 
            // https://stackoverflow.com/questions/56651073/when-encoding-a-png-to-base64-and-then-turning-it-back-into-a-pixbuf-i-get-an-fo
            // Save the pixbuf.
